...
extension Restaurant {
    static let dummyData: [Restaurant] = [
        ...
        Restaurant(name: "Mai3 Cafegan Vegetarian Cafe", category: "Vegan Restaurant", distance: "700 m", address: "6X, Jl. Raya Tuban No.1, Tuban, Kec. Kuta, Kabupaten Badung, Bali 80361", avgRating: 4.4, totalReviews: 387, isCertified: false, latitude: -8.740937412998631, longitude: 115.17889090610126),
